#!/usr/bin/env python
"""Robustness: SWA on 0.5° rect region — 100 epochs, top-3 checkpoint averaging"""
...
RECT = (61.5, 62.0, 34.0, 34.5)  # 0.5deg x 0.5deg NW
REGION_KEY = 'small'

print("=" * 60)
print(f"  SWA 鲁棒性实验 — 0.5deg rect")
...
results = {
    ...
    'config': {
        'mode': 'swa', 'region': '0.5deg rect NW',
