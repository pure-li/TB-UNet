#!/usr/bin/env python
"""Robustness: SWA on 0.5° NW region — 100 epochs
Region: 61.3-61.8°E, 34.8-35.3°N (0.5° × 0.5°, NW)"""
...
CKPT_DIR = os.path.join(OUT_DIR, 'checkpoints_nw05')
...
RECT = (61.3, 61.8, 34.8, 35.3)  # 0.5° × 0.5° NW
REGION_KEY = 'nw05'

print("=" * 60)
print(f"  SWA 鲁棒性实验 — 0.5° NW region")
print(f"  RECT: {RECT}")
...
results = {
    ...
    'config': {'mode': 'swa', 'region': '0.5deg NW', 'rect': RECT, 'epochs': EPOCHS,
               'max_lr': MAX_LR, 'base_ch': BASE_CH, 'n_params': n_params,}
}
with open(os.path.join(OUT_DIR, 'results_nw05.json'), 'w') as f:
