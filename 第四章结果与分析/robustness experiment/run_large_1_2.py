#!/usr/bin/env python
"""1.5° 大区域重跑 — U-Net+TF (slow训练方式) + Kriging
========================================================
区域: 60.85-62.35°E, 33.65-35.15°N (1.5° × 1.5°, NW)
...
# 1.2° SE blank
RECT = (60.85, 62.35, 33.65, 35.15)
REGION_KEY = 'large'
REGION_LABEL = 'Large (1.5deg x 1.5deg, NW)'

print("=" * 60)
print(f"  {REGION_LABEL} — U-Net+TF + Kriging")
...
# =============================================================================
# Load data once (shared between methods)
# =============================================================================
print("\nLoading data...")
...
# InpaintingDataset + DataLoader (slow-style)
...
unet_results['small'] = unet_results.get('small', {'rmse': 24.47, 'mae': 21.19, 'best_epoch': 38})
...
print(f"  Total time: {(time.time()-t_train+time.time()):.0f}s")
print("=" * 60)
