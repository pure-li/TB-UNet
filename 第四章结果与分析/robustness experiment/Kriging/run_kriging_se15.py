"""Kriging on 1.5° SE region: 64.75-66.25°E, 30.25-31.75°N"""
...
RECT = (64.75, 66.25, 30.25, 31.75)
REGION_KEY = 'se15'

print("=" * 60)
print(f"  Kriging — 1.5° SE region: {RECT}")
print("=" * 60)
...
with open(os.path.join(OUT_DIR, f'results_{REGION_KEY}.json'), 'w') as f:
    json.dump({'region': '1.5° SE', 'rect': RECT, 'rmse': rmse, 'mae': mae, 'time': krige_time}, f, indent=2)
