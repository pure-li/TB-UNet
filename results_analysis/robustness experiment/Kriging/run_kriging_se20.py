"""Kriging on 2.0° SE region: 64.5-66.5°E, 30.0-32.0°N"""
...
RECT = (64.5, 66.5, 30.0, 32.0)
REGION_KEY = 'se20'

print("=" * 60)
print(f"  Kriging — 2.0° SE region: {RECT}")
print("=" * 60)
...
with open(os.path.join(OUT_DIR, f'results_{REGION_KEY}.json'), 'w') as f:
    json.dump({'region': '2.0° SE', 'rect': RECT, 'rmse': rmse, 'mae': mae, 'time': krige_time}, f, indent=2)
