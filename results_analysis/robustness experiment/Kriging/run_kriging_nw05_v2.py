"""Kriging on 0.5deg NW v2 region: 61.5-62.0degE, 34.2-34.7degN"""
...
print("=" * 60)
print(f"  Kriging — 0.5deg NW v2 region: {RECT}")
print("=" * 60)
...
with open(os.path.join(OUT_DIR, f'results_{REGION_KEY}.json'), 'w') as f:
    json.dump({'region': '0.5deg NW v2', 'rect': RECT, 'rmse': rmse, 'mae': mae, 'time': krige_time}, f, indent=2)
