#!/usr/bin/env python
"""Robustness: SWA on 1.5° SE region — 100 epochs
Region: 64.75-66.25°E, 30.25-31.75°N (1.5° × 1.5°, SE)"""
...
CKPT_DIR = os.path.join(OUT_DIR, 'checkpoints_se15')
...
RECT = (64.75, 66.25, 30.25, 31.75)  # 1.5° × 1.5° SE
REGION_KEY = 'se15'

print("=" * 60)
print(f"  SWA 鲁棒性实验 — 1.5° SE region")
print(f"  RECT: {RECT}")
...
results = {
    ...
    'config': {'mode': 'swa', 'region': '1.5deg SE', 'rect': RECT, 'epochs': EPOCHS,
               'max_lr': MAX_LR, 'base_ch': BASE_CH, 'n_params': n_params,}
}
with open(os.path.join(OUT_DIR, 'results_se15.json'), 'w') as f:
