#!/usr/bin/env python
"""消融实验 — U-Net + Transformer (无跳跃连接)
=============================================
架构: U-Net编码器-Transformer瓶颈-解码器, 无跳跃连接 (本模型/参考组)
...
print("=" * 60)
print("  Ablation: U-Net + Transformer (no skip) — retrain @200 epochs")
...
def train_model(data, prep, region_key):
    print(f"\n[U-Net + TF] Training {region_key}, epochs={EPOCHS}")
...
summary['config'] = {'model': 'U-Net + Transformer (no skip)',
